...
namespace SafeExamBrowser.Communication.Contracts.Proxies
{
	...
	public interface IRuntimeProxy : ICommunicationProxy
	{
		...
		/// <summary>
		/// Blinkered: informs the runtime that the first-site content has finished rendering (CEF LoadEnd), so it can
		/// tear down the launch cover on real content-ready.
		/// </summary>
		CommunicationResult InformContentReady();
