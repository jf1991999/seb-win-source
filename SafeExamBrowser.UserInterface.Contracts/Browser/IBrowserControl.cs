...
namespace SafeExamBrowser.UserInterface.Contracts.Browser
{
	...
	public interface IBrowserControl
	{
		...
		/// <summary>
		/// Gives the browser control OS keyboard focus. Blinkered: called after the main window is activated for a
		/// home-page modal so the page's own <c>element.focus()</c> actually lands the caret — CefSharp does not grant
		/// keyboard focus from DOM focus alone when the control is not OS-focused.
		/// </summary>
		void Focus();
