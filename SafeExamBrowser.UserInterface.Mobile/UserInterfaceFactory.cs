...
namespace SafeExamBrowser.UserInterface.Mobile
{
	public class UserInterfaceFactory : IUserInterfaceFactory
	{
		...
		public IAccentPopup CreateAccentPopup()
		{
			return new NullAccentPopup();   // the touch-optimized UI does not provide press-and-hold accents
		}
		...
		public IWindow CreateLaunchCover(AppConfig appConfig = null)
		{
			return null;   // desktop-only launch cover (used by the Runtime's Desktop UI); not applicable on the mobile UI
		}

		public ISplashScreen CreateSplashScreen(AppConfig appConfig = null, bool show = true)
		{
			return windowFactory.CreateSplashScreen(appConfig, show);
		}
